...
-- Generated: 2026-08-23T12:37:39+00:00
...
CREATE TABLE `admins` (
  ...
  `deleted_at` datetime NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `admins_admin_code_unique` (`admin_code`),
  UNIQUE KEY `admins_user_id_unique` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `admins` (`id`, `user_id`, `admin_code`, `status`, `metadata`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'ADM-00001', 'active', NULL, '2026-08-09 08:31:12', '2026-08-23 12:34:07', NULL),
(2, 2, 'ADM-00002', 'active', NULL, '2026-08-09 08:31:13', '2026-08-23 12:34:07', NULL);
...
('laravel-cache-7939ad1a23e0b58a4aa7b3931c88b56d:timer', 'i:1787488676;', 1787488676),
('laravel-cache-7939ad1a23e0b58a4aa7b3931c88b56d', 'i:1;', 1787488676);
...
('SRgfD5uLJ3GXJYBjfNmfEu2DcCFjJtPqLohHExJI', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 OPR/134.0.0.0', '', 1787488616),
