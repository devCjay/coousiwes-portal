...
class SupervisorLoginDetailsNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(EmailTemplate::subject('supervisor_login_details', 'COOU SIWES Supervisor Portal Login Details', $replacements))
            ->greeting("Hello {$notifiable->name},")
            ->lines($body)
            ->action('Login to Supervisor Portal', route('login.supervisor'));
    }
}
